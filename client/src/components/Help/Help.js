  ...
  return (
    <div>
      <center>
        ...
        <div>
          {" "}
          You can email us at foodchive@gmail.com. Please ensure to include your
          complete company name and contact information.
        </div>
        <div>
          {" "}
        ...
        <h2>Contact Form</h2>
        <div>
          To ensure that we answer all of your questions and queries, please use
          our Contact Form down below.
        </div>
        <iframe
